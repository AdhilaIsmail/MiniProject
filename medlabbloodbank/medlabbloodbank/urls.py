...
from website.views import adminindex, activities, appointments, doctors, departments, employees, profile, editprofile, registereddonortable, search_by_name, search_by_place,search_by_blood_group, addhospitals
